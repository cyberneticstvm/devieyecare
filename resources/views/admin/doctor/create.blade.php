...
<div class="col-12">
    <div class="mb-4 pt-3">
        <h5 class="fw-medium text-uppercase mb-0">Create Doctor</h5>
        <p class="fs-12">Create New Doctor</p>
            ...
            <div class="col-lg-12">
                ...
                <div class="row g-3">
                    <div class="control-group col-md-3">
                        ...
                        {{ html()->text('name', old('name') ?? '')->class('form-control')->placeholder('Doctor Name') }}
                        @error('name')
                    ...
                    <div class="control-group col-md-2">
                        ...
                        {{ html()->text('code', old('code') ?? '')->maxlength(10)->class('form-control')->placeholder('Doctor Code') }}
                        @error('code')
                    ...
                    <div class="control-group col-md-2">
                        ...
                        {{ html()->number('fee', old('fee') ?? '', '0', '', '1')->class('form-control')->placeholder('0.00') }}
                        @error('fee')
