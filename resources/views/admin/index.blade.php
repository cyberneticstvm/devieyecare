        ...
        <div class="row g-lg-4 g-3">
            <div class="col-lg-8">
                <table class="Data_Table table table-round align-middle mb-0 table-hover w-100 mt-2 border-top" id="apptTable">
                    ...
                    <tbody>
                        @forelse(getAppointments() as $key => $appointment)
                        <tr>
                            <td>{{ $key + 1 }}</td>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="control-group col-md-4">
                                                ...
                                                {{ html()->select($name = 'gender', $value = getGenders(), old('gender'))->class('form-select')->placeholder('Select') }}
                                                @error('gender')
                                            ...
                                            <div class="control-group col-md-6">
                                                ...
                                                {{ html()->select($name = 'branch_id', $value = getBranches(), old('branch_id'))->class('form-select')->placeholder('Select') }}
                                                @error('branch_id')
                                            ...
                                            <div class="control-group col-md-6">
                                                ...
                                                {{ html()->select($name = 'doctor_id', $value = getDoctors(), old('doctor_id'))->class('form-select')->placeholder('Select') }}
                                                @error('doctor_id')
