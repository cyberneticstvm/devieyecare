                ...
                <table class="Data_Table table table-round align-middle mb-0 table-hover w-100 mt-2 border-top" id="apptTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="{{ route('registration.create', ['rtype' => encrypt('Appointment'), 'typeid' => encrypt($appointment->id), 'search_type' => 'new']) }}" data-toggle="tooltip" data-placement="top" title="Click here to register the patient">{{ $appointment->name }}</a></td>
