...
<div class="col-12">
    <div class="border-top mb-4 pt-3">
        <h5 class="fw-medium text-uppercase mb-0">Expense Report</h5>
        <p class="fs-12">Expense Report</p>
        <div class="row g-lg-12 g-3">
            <div class="col-lg-12">
                {{ html()->form('POST')->route('report.expense.fetch')->class('')->open() }}
                <div class="row g-3">
                    ...
                    <div class="control-group col-md-2">
                        ...
                        {{ html()->select('head_id', $heads, old('head_id') ?? $inputs[3])->class('select2') }}
                    </div>
                </div>
                <div class="raw mt-3">
...
<div class="col-12">
    <div class="border-top mb-4 pt-3">
        <h5 class="fw-medium text-uppercase mb-0">Expense Report</h5>
        <p class="fs-12">Showing expenses between {{ $inputs[0] }} and {{ $inputs[1] }}</p>
                ...
                <table class="Data_Table table table-round align-middle mb-0 table-hover w-100 mt-2 border-top" id="apptTable">
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <td class="fw-bold">{{ number_format($records->sum('amount'), 2) }}</td>
                        </tr>
                    </tfoot>
                </table>
            </div>
