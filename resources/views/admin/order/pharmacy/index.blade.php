...
<div class="col-12">
    <div class="border-top mb-4 pt-3">
        <h5 class="fw-medium text-uppercase mb-0">Pharmacy Register</h5>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('pharmacy.order.edit', encrypt($order->id)) }}" class="text-secondary">Edit</a> | <a href="{{ route('pharmacy.order.delete', encrypt($order->id)) }}" class="text-danger dlt">Delete</a>
                            </td>
                        </tr>
                        @empty
                        @endforelse
